...
public class PQusingJAVACollections {
    ...
    // There are no such classes to compare between them, so this interface gives a
    // special power for that classes can compare their objects
    // Now student class can compare on the basis of rank and roll no. etc.
    // There is a function called compareTo() in this Comparable interface. The
    // student child class can implement parent's (this interface) function
    // Whenever child class implement parent class's function this concept is called
    // function overriding
    static class student implements Comparable<student> {
        ...
        // it this.rank-s2.rank gives -ve number then object 1 is having less rank than
        // object 2. So lesser value will come before the higher value
        // if it's +ve then object 1 is having higher rank than object 2. Then object 2
        // will come first.
        // If it's 0 then both object's rank are same. So no change.
        // as java has its inbuilt feature , so sorting based on rank will be done
        // automatically with this logic (return +ve , -ve , 0 value)
    }
